...
102561.97 40 46 2.51 1 111 50 51.86 -1 1416.66\n"
    ...
    (fact "Program does the right stuff"
      (let [data (-> "data.dat" file->matrix (get-column 0) parse-data)
        ...
        results => (just [(just [3 (roughly 12122.9172) 26052343.13778725 2986153.9652697924 4264669.833325115])
                          (just [4 (roughly 12122.9181) -17183556.33086311 -1.8640834276186436E7 7941901.319733662])
                          (just [8 (roughly 12122.9151) 18498279.256616846 -1.4172390064384513E7 -1.2758766855293432E7])
                          (just [11 (roughly 12122.929) -2903225.4285143306 -1.9661358537802488E7 1.7630410370147068E7])
                          (just [14 (roughly 12122.9308) 1477645.012869009 -1.5214872308462147E7 2.172908956016601E7])
                          (just [15 (roughly 12122.9155) 26526323.652830362 847508.5779779141 -1210367.686336006])
                          (just [17 (roughly 12122.9321) 4939777.113795485 -1.796566328317718E7 1.893839095916287E7])
                          (just [20 (roughly 12122.9302) 17903461.11594521 -1.680512822049418E7 1.0143118495964047E7])
                          (just [3 (roughly 12123.9172) 26051583.57529224 2988333.2598188072 4267782.188491394])
                          (just [4 (roughly 12123.9181) -17182471.209298465 -1.8643093190170433E7 7938946.196116364])
                          (just [8 (roughly 12123.9151) 18498702.477611426 -1.4169522466848126E7 -1.2761337977143275E7])
                          (just [11 (roughly 12123.9294) -2900527.5635450673 -1.9663425257925782E7 1.7628549408265613E7])
                          (just [14 (roughly 12123.9308) 1481513.6606823928 -1.5214748538998244E7 2.1728912799052842E7])
                          (just [15 (roughly 12123.9155) 26526107.876559697 849727.5371656624 -1213536.6884770312])
                          (just [17 (roughly 12123.9321) 4942411.176984259 -1.796329047680593E7 1.8939954441975158E7])
                          (just [20 (roughly 12123.9302) 17904260.819928236 -1.680258096219933E7 1.0145926510738155E7])])))))
